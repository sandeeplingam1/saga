...
# Saga: Internal Audit Assistant


Saga is a customized internal assistant for audit workflows, built for your company. It enables natural language search and chat over your internal audit data, leveraging Azure OpenAI and Azure Cognitive Search services. The assistant is tailored for compliance, audit, and internal review processes.

Saga's backend is written in Python. The project is designed for extensibility and security, with a focus on audit, compliance, and internal review use cases. Learn more about [developing AI apps using Azure AI Services](https://aka.ms/azai).
...
3. Run this command to download the project code:
    ...
    ```shell
  # Initialize environment and download project code
    ```
